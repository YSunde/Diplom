									...
									<nav className='main_nav'>
										<ul>
											...
											<li className='hassubs'>
												...
												<ul>
													<li>
														<a href='categories.html'>Камеры</a>
													</li>
													<li>
														<a href='categories.html'>Смартфоны</a>
													</li>
													<li>
														<a href='categories.html'>Планшеты</a>
													</li>
													<li>
														<a href='categories.html'>Колонки</a>
													</li>
													<li>
														<a href='categories.html'>Наушники</a>
													</li>
												</ul>
											</li>
											<li>
